...
const Home = () => {
  ...
  const slides = [
    ...
    },
    {
      ...
      subtitle: `Dom Immo Services and Consulting Sarl - Domisc Sarl accompagne le développement industriel et domestique avec des solutions innovantes et durables.`,
