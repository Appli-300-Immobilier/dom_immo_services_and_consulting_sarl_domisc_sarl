// Catalogue de 100 biens pour Dom Immo Services and Consulting Sarl - Domisc Sarl
...
export const MOCK_USERS_LIST = [
  ...
  { id: 'u3', name: 'Aubry Admin', email: 'admin@domimmoservicesandconsultingsarldomiscsarl.cm', role: 'admin', status: 'Actif', joinDate: '01/01/2026' }
];
